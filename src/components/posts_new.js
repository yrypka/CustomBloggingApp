...
class PostsNew extends Component {
  ...
  onSubmit(props) {
    this.props.createPost(props)
      .then(() => {
        // blog post has been created, navigating ther user to the index
        // We navigate by calling this.context.router.push with the 
        // new path to navigate to.
        // this.context.router.push('/');

        // Update path through browserHistory rather then this.context.router
        browserHistory.push('/');
      });
  }
...
// connect: first argument is mapStateToProps, 2nd is mapDispatch to props
